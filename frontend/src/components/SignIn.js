...
import { authInstagram } from "../services/api"; // Assuming this is from your services
import { loginWithInstagram } from "../utils/socialAuth"; // Assuming this is from your utils

// --- Helper Component for Google Login ---
// This contains the new, secure logic for Google Sign-In.
const GoogleLoginButton = ({ onSignIn, setIsLoading }) => {
    const login = useGoogleLogin({
        // This requests an ID token from Google.
        flow: 'implicit',
        ...
        onSuccess: async (tokenResponse) => {
            ...
            try {
                ...
                // Handle successful login from backend response
...
export default function SignIn({ onSignIn, onClose }) {
    ...
    if (!googleClientId) {
        console.error("FATAL: REACT_APP_GOOGLE_CLIENT_ID is not defined in your .env file.");
    }
    ...
    const handleInstagramLogin = async () => {
        ...
        try {
            ...
            alert(`Instagram login failed: ${error.message}. Please try again.`);
        } finally {
            setIsLoading(false);
        }
    };
            ...
            <div className="signin-modal-overlay">
                <div className="signin-modal">
                    ...
                    <div className="social-icons">
                        <GoogleLoginButton onSignIn={onSignIn} setIsLoading={setIsLoading} />
                        <button
                    ...
                    <div className="form-fields">
                        <div className="input-group">
                            ...
                            <input placeholder="Username or Email" value={email} onChange={(e) => setEmail(e.target.value)} className="form-input" />
                        </div>
                        <div className="input-group">
                            <label className="input-label">Password</label>
                            <input placeholder="Enter password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} className="form-input" />
                        </div>
                    ...
                    <button onClick={doEmailLogin} className="signin-btn" disabled={isLoading}>
                        ...
                        <div className="register-modal">
                            ...
                            <div className="form-fields">
                                <div className="input-group">
                                    ...
                                    <input placeholder="Enter your email address" type="email" value={registerData.email} onChange={(e) => handleRegisterInputChange('email', e.target.value)} className="form-input" />
                                </div>
                                <div className="input-group">
                                    <label className="input-label">Password *</label>
                                    <input placeholder="Create a strong password" type="password" value={registerData.password} onChange={(e) => handleRegisterInputChange('password', e.target.value)} className="form-input" />
                                </div>
                                <div className="input-group">
                                    <label className="input-label">Contact Number *</label>
                                    <input placeholder="Enter your contact number" type="tel" value={registerData.phone} onChange={(e) => handleRegisterInputChange('phone', e.target.value)} className="form-input" />
                                </div>
                                <div className="input-group">
                                    <label className="input-label">Account Type *</label>
                                    <select value={registerData.role} onChange={(e) => handleRegisterInputChange('role', e.target.value)} className="form-select">
                                        <option value="citizen">Citizen - Report Emergencies</option>
                                        <option value="admin">Admin - Manage Emergency Services</option>
                                    </select>
                                </div>
                            </div>
                            <button onClick={doEmailRegister} className="signup-btn" disabled={isLoading}>
